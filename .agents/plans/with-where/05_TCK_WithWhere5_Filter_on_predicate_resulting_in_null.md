# WithWhere5 - Filter on predicate resulting in null - Task List
...
**Feature File:** `tck/features/clauses/with-where/WithWhere5.feature`
**Total Scenarios:** 4
...
### Phase 1: Foundation
**Goal:** Implement basic WithWhere5 functionality
**Timeline:** TBD
...
```
tck/features/clauses/with-where/WithWhere5.feature
```
