# WithWhere2 - Filter multiple variables - Task List
...
**Feature File:** `tck/features/clauses/with-where/WithWhere2.feature`
**Total Scenarios:** 2
...
### Phase 1: Foundation
**Goal:** Implement basic WithWhere2 functionality
**Timeline:** TBD
...
```
tck/features/clauses/with-where/WithWhere2.feature
```
