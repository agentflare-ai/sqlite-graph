# MatchWhere4 - Non-Equi-Joins on variables - Task List
...
**Feature File:** `tck/features/clauses/match-where/MatchWhere4.feature`
**Total Scenarios:** 2
...
### Phase 1: Foundation
**Goal:** Implement basic MatchWhere4 functionality
**Timeline:** TBD
...
```
tck/features/clauses/match-where/MatchWhere4.feature
```
