...
### 🔴 [Scenario 01] Two elements, both unique, not distinct
**Status:** 🔴 NOT STARTED
**Priority:** LOW
...
### 🔴 [Scenario 02] Three elements, two unique, not distinct
**Status:** 🔴 NOT STARTED
**Priority:** LOW
...
### 🔴 [Scenario 03] Two single-column inputs, one with duplicates, not distinct
**Status:** 🔴 NOT STARTED
**Priority:** LOW
...
### 🔴 [Scenario 04] Should be able to create text output from union all queries
**Status:** 🔴 NOT STARTED
**Priority:** LOW
...
### 🔴 [Scenario 05] Failing when UNION ALL has different columns
**Status:** 🔴 NOT STARTED
**Priority:** LOW
